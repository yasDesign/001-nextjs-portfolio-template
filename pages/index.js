...
export default function Home() {
  return (
    <div>
      ...
      <Script strategy='beforeInteractive' src="assets/js/slick.js"></Script>
      <Script strategy='beforeInteractive' src="assets/js/templatemo-script.js"></Script>
            ...
            <div  className="page-width-1 page-left">
              <div  className="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                ...
                <div  className="intro-right">
                  <img src="assets/img/home-img-1.jpg" alt="Image"  className="img-fluid intro-img-1"/>
                  <img src="assets/img/home-img-2.jpg" alt="Image"  className="img-fluid intro-img-2"/>
                </div>
            ...
            <div  className="mx-auto position-relative gallery-container">
              ...
              <div  className="mx-auto tm-border-top gallery-slider">
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-01.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-02.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-03.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-04.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-05.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-06.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-07.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-08.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure  className="effect-julia item">
                    <img src="assets/img/gallery-img-09.jpg" alt="Image"/>
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
    ...
    <div  className="container-fluid">
      <footer  className="row mx-auto tm-footer">
        ...
        <div  className="col-md-6 px-0 tm-footer-right">
          Designed by <a rel="sponsored" href="https://templatemo.com" target="_blank"  className="tm-link-white">TemplateMo</a>
        </div>
      </footer>
    </div>
  </div>
